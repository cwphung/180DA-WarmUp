...
def on_connect(client, userdata, flags, rc):
    ...
    client.publish("ece180d/test/ahh/raspi", '1', qos=1)
...
def on_message(client, userdata, message):
    ...
    if topics[-1] != 'raspi':
        ...
        time.sleep(1)
        print('Sent message: \"' + str(next_val) + '\" on topic \"' + "ece180d/test/ahh/raspi" + '\" with QoS ' + str(message.qos))
        client.publish("ece180d/test/ahh/raspi", str(next_val), qos=1)
